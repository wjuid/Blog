...
- 基本操作
  ...
  - 常规操作
    ...
    - 文件树
      ...
      - [文件树中打开文件](https://spacevim.org/cn/documentation/#文件树中打开文件)
...
SpaceVim 添加了 [EditorConfig](http://editorconfig.org/) 支持，通过一个配置文件来为不同的文件格式设置对应的代码格式规范， 这一工具兼容多种文本编辑器和集成开发环境。
